...
namespace BuilderCalculatorMVC.Infrastructure.Migrations
{
    ...
    [Migration("20210427164009_Initial")]
            ...
            modelBuilder.Entity("BuilderCalculatorMVC.Domain.Model.ContactType", b =>
                {
                    ...
                    b.Property<int>("ModifiedByAppUserId")
                        .HasColumnType("int");

                    b.Property<string>("ModifiedByAppUserId1")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("ModifiedByAppUserId1");
            ...
            modelBuilder.Entity("BuilderCalculatorMVC.Domain.Model.ContactType", b =>
                {
                    ...
                    b.HasOne("BuilderCalculatorMVC.Domain.Models.AppUser", "ModifiedByAppUser")
                        .WithMany()
                        .HasForeignKey("ModifiedByAppUserId1");
                });
